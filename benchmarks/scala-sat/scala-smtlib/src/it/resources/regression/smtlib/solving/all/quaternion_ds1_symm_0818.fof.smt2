...
(declare-fun xinit_noise () (Array Int Real))
...
(assert (not (= def use)))
(assert (not (=> (and (forall ((?A_59 Int) (?B_60 Int)) (=> (and (and (and (>= ?A_59 0) (>= ?B_60 0)) (<= ?A_59 5)) (<= ?B_60 5)) (= (select (select q_ds1_filter ?A_59) ?B_60) (select (select q_ds1_filter ?B_60) ?A_59)))) (forall ((?C_61 Int) (?D_62 Int)) (=> (and (and (and (>= ?C_61 0) (>= ?D_62 0)) (<= ?C_61 2)) (<= ?D_62 2)) (= (select (select r_ds1_filter ?C_61) ?D_62) (select (select r_ds1_filter ?D_62) ?C_61))))) (forall ((?E_63 Int) (?F_64 Int)) (let ((?v_0 (= 5 ?F_64)) (?v_1 (= 5 ?E_63))) (=> (and (and (and (>= ?E_63 0) (>= ?F_64 0)) (<= ?E_63 5)) (<= ?F_64 5)) (=> (and (and (and (and (and (not (and (= 3 ?E_63) ?v_0)) (not (and (= 4 ?E_63) ?v_0))) (not (and ?v_1 ?v_0))) (= 2 ?E_63)) ?v_1) ?v_0) (= (select xinit_noise 5) 0.0))))))))
(check-sat)
(exit)
